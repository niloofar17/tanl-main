...
class DataTrainingArguments:
    ...
    data_dir: Optional[str] = field(
        default='/ukp-storage-1/asadi/tanl-main/snips/snips.spt_s_5.q_s_20.ep_100.cross_id_1',
    ...
    # few-shot arguments
    num_shots: int = field(
        default=5, metadata={"help": "number of shots (few-shot argument for the FewRel dataset)"}
    )
